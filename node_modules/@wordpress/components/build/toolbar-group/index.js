...
function ToolbarGroup(_ref) {
  var _ref$controls = _ref.controls,
      ...
      icon = _ref.icon,
      title = _ref.title,
      otherProps = (0, _objectWithoutProperties2.default)(_ref, ["controls", "children", "className", "isCollapsed", "icon", "title"]);
  ...
  return (0, _element.createElement)(_toolbarGroupContainer.default, (0, _extends2.default)({
    className: finalClassName
  }, otherProps), (0, _lodash.flatMap)(controlSets, function (controlSet, indexOfSet) {
