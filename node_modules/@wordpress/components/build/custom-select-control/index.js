...
function CustomSelectControl(_ref3) {
  ...
  return (0, _element.createElement)("div", {
    ...
    className: (0, _classnames.default)('components-custom-select-control__label', {
  ...
  }), itemToString(selectedItem), (0, _element.createElement)(_.Dashicon, {
    ...
    return (// eslint-disable-next-line react/jsx-key
      (0, _element.createElement)("li", getItemProps({
        ...
        index: index,
        key: item.key,
        className: (0, _classnames.default)('components-custom-select-control__item', {
