...
function Guide(_ref) {
  ...
  var numberOfPages = _element.Children.count(children);
  ...
  }, children[currentPage], !canGoForward && (0, _element.createElement)(_finishButton.default, {
    className: "components-guide__inline-finish-button",
    onClick: onFinish
  }, finishButtonText || (0, _i18n.__)('Finish')), (0, _element.createElement)("div", {
    className: "components-guide__footer"
  }, canGoBack && (0, _element.createElement)(_iconButton.default, {
    className: "components-guide__back-button",
    icon: (0, _element.createElement)(_icons.BackButtonIcon, null),
    onClick: goBack
  }, (0, _i18n.__)('Previous')), (0, _element.createElement)(_pageControl.default, {
    currentPage: currentPage,
    numberOfPages: numberOfPages,
    setCurrentPage: setCurrentPage
  }), canGoForward && (0, _element.createElement)(_iconButton.default, {
    className: "components-guide__forward-button",
    icon: (0, _element.createElement)(_icons.ForwardButtonIcon, null),
    onClick: goForward
