...
export var SVG = function SVG(props) {
  ...
  var defaultStyle = props.__unstableActive ? styles['is-active'] : styles['components-toolbar__control-' + colorScheme];
  var styleValues = Object.assign.apply(Object, [{}, props.style, defaultStyle].concat(_toConsumableArray(stylesFromClasses)));
