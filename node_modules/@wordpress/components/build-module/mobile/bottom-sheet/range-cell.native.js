...
function (_Component) {
  ...
  function BottomSheetRangeCell(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BottomSheetRangeCell).call(this, props));
  ...
  _createClass(BottomSheetRangeCell, [{
    ...
    value: function componentDidUpdate() {
      var reset = this.props.value === null;
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          _this$props3$allowRes = _this$props3.allowReset,
          allowReset = _this$props3$allowRes === void 0 ? true : _this$props3$allowRes,
          cellProps = _objectWithoutProperties(_this$props3, ["value", "defaultValue", "minimumValue", "maximumValue", "disabled", "step", "preferredColorScheme", "minimumTrackTintColor", "maximumTrackTintColor", "thumbTintColor", "getStylesFromColorScheme", "allowReset"]);
      ...
      var resetButtonText = Platform.OS === 'ios' ? __('Reset') : __('RESET');
      var resetButton = {
