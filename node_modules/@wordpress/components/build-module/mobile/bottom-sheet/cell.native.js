...
function (_Component) {
  ...
  function BottomSheetCell(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BottomSheetCell).apply(this, arguments));
    _this.state = {
  ...
  _createClass(BottomSheetCell, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          valueProps = _objectWithoutProperties(_this$props, ["accessible", "accessibilityLabel", "accessibilityHint", "accessibilityRole", "onPress", "label", "value", "valuePlaceholder", "icon", "leftAlign", "labelStyle", "valueStyle", "cellContainerStyle", "cellRowContainerStyle", "onChangeValue", "children", "editable", "separatorType", "style", "getStylesFromColorScheme", "customActionButton", "type", "step"]);
      ...
      var defaultLabelStyle = showValue || icon !== undefined || customActionButton ? cellLabelStyle : defaultMissingIconAndValue;
      ...
      }, title))), showValue && getValueComponent(), children), !drawTopSeparator && createElement(View, {
        style: separatorStyle()
      }));
    }
  }]);
