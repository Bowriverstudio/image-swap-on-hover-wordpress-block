...
import { BlockControls, BlockVerticalAlignmentToolbar, InnerBlocks, InspectorControls, PanelColorSettings, withColors, __experimentalImageURLInputUI as ImageURLInputUI } from '@wordpress/block-editor';
...
function (_Component) {
  ...
  _createClass(MediaTextEdit, [{
    ...
    value: function render() {
      ...
      }, _defineProperty(_classnames, backgroundColor.class, backgroundColor.class), _defineProperty(_classnames, 'is-stacked-on-mobile', isStackedOnMobile), _defineProperty(_classnames, "is-vertically-aligned-".concat(verticalAlignment), verticalAlignment), _defineProperty(_classnames, 'is-image-fill', imageFill), _classnames));
...
export default compose([withColors('backgroundColor'), withSelect(function (select, props) {
