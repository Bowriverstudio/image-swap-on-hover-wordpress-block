...
export var UnsupportedBlockEdit =
/*#__PURE__*/
function (_Component) {
  ...
  function UnsupportedBlockEdit(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UnsupportedBlockEdit).call(this, props));
    _this.state = {
      showHelp: false
    };
    return _this;
  ...
  _createClass(UnsupportedBlockEdit, [{
    ...
    value: function renderSheet(title) {
      ...
      var infoSheetIconStyle = getStylesFromColorScheme(styles.infoSheetIcon, styles.infoSheetIconDark); // translators: %s: Name of the block

      var titleFormat = Platform.OS === 'android' ? __("'%s' isn't yet supported on WordPress for Android") : __("'%s' isn't yet supported on WordPress for iOS");
    ...
    value: function render() {
      ...
      var icon = blockType ? normalizeIconObject(blockType.settings.icon) : 'admin-plugins';
