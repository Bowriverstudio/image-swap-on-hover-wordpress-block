...
import { BlockControls, BlockIcon, InspectorControls, MediaPlaceholder, MediaReplaceFlow, RichText } from '@wordpress/block-editor';
...
function (_Component) {
  ...
  function AudioEdit() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioEdit).apply(this, arguments));
    _this.toggleAttribute = _this.toggleAttribute.bind(_assertThisInitialized(_this));
  ...
  _createClass(AudioEdit, [{
    ...
    value: function toggleAttribute(attribute) {
      ...
      return function (newValue) {
        _this2.props.setAttributes(_defineProperty({}, attribute, newValue));
      };
    }
  }, {
    key: "onSelectURL",
