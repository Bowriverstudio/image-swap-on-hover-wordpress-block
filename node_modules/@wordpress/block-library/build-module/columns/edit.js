...
import { InspectorControls, InnerBlocks, BlockControls, BlockVerticalAlignmentToolbar, __experimentalBlockVariationPicker, __experimentalUseColors } from '@wordpress/block-editor';
...
function ColumnsEditContainer(_ref) {
  ...
  var classes = classnames(className, _defineProperty({}, "are-vertically-aligned-".concat(verticalAlignment), verticalAlignment));
  return createElement(Fragment, null, createElement(BlockControls, null, createElement(BlockVerticalAlignmentToolbar, {
    ...
    min: 2,
    max: 6
  }))), InspectorControlsColorPanel, createElement(BackgroundColor, null, createElement("div", {
    className: classes
...
var ColumnsEdit = function ColumnsEdit(props) {
  ...
  if (hasInnerBlocks) {
    return createElement(ColumnsEditContainerWrapper, props);
  }

  return createElement(__experimentalBlockVariationPicker, {
