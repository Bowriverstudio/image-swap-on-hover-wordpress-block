...
var registerCoreBlocks = function registerCoreBlocks() {
  ...
  shortcode, archives, audio, button, buttons, calendar, categories, code, columns, column, cover, embed].concat((0, _toConsumableArray2.default)(embed.common), (0, _toConsumableArray2.default)(embed.others), [file, group, window.wp && window.wp.oldEditor ? classic : null, // Only add the classic block in WP Context
  html, mediaText, latestComments, latestPosts, missing, more, navigation, navigationLink, nextpage, preformatted, pullquote, rss, search, separator, reusableBlock, spacer, subhead, table, tagCloud, textColumns, verse, video]).forEach(registerBlock);
...
var __experimentalRegisterExperimentalCoreBlocks = process.env.GUTENBERG_PHASE === 2 ? function (settings) {
  ...
  [__experimentalEnableLegacyWidgetBlock ? legacyWidget : null, socialLinks].concat((0, _toConsumableArray2.default)(socialLink.sites), (0, _toConsumableArray2.default)(__experimentalEnableFullSiteEditing ? [siteTitle, templatePart, postTitle, postContent, postAuthor, postDate, postExcerpt] : [])).forEach(registerBlock);
} : undefined;
