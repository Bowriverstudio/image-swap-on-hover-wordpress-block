...
var removeButtonStyle = compose(_galleryImageStyle.default.removeButton, {
  aspectRatio: 1
});
...
function (_Component) {
  ...
  (0, _createClass2.default)(GalleryImage, [{
    ...
    value: function onMediaPressed() {
      ...
      } else if (this.state.didUploadFail || id && !(0, _url.isURL)(url)) {
    ...
    value: function renderContent(params) {
      ...
      var imageStyle = [_galleryImageStyle.default.image, {
        resizeMode: resizeMode
      }, isUploadInProgress ? _galleryImageStyle.default.imageUploading : undefined];
      var overlayStyle = compose(_galleryImageStyle.default.overlay, isSelected ? _galleryImageStyle.default.overlaySelected : undefined);
      ...
      var captionStyle = shouldShowCaptionExpanded ? _galleryImageStyle.default.captionExpanded : getStylesFromColorScheme(_galleryImageStyle.default.caption, _galleryImageStyle.default.captionDark);
      return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_reactNative.Image, {
        style: imageStyle,
        source: {
          uri: url
        } // alt={ alt }
      ...
      }, retryMessage)), (0, _element.createElement)(_reactNative.View, {
        style: overlayStyle
      }, !isUploadInProgress && (0, _element.createElement)(_element.Fragment, null, isSelected && (0, _element.createElement)(_reactNative.View, {
        ...
        onClick: onRemove,
        accessibilityLabel: (0, _i18n.__)('Remove Image'),
        disabled: !isSelected
      })), (shouldShowCaptionEditable || shouldShowCaptionExpanded) && (0, _element.createElement)(_reactNative.View, {
