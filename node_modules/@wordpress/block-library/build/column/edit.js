...
var _default = (0, _compose.compose)((0, _data.withSelect)(function (select, ownProps) {
  ...
  return {
    ...
    updateWidth: function updateWidth(width) {
      ...
      var nextColumnWidths = _objectSpread({}, (0, _utils.getColumnWidths)(columns, columns.length), (0, _defineProperty2.default)({}, clientId, (0, _utils.toWidthPrecision)(width)), (0, _utils.getRedistributedColumnWidths)(adjacentColumns, 100 - occupiedWidth, columns.length));
