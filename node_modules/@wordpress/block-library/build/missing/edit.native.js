...
function (_Component) {
  ...
  function UnsupportedBlockEdit(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(UnsupportedBlockEdit).call(this, props));
    _this.state = {
      showHelp: false
    };
    return _this;
  ...
  (0, _createClass2.default)(UnsupportedBlockEdit, [{
    ...
    value: function renderSheet(title) {
      ...
      var infoSheetIconStyle = getStylesFromColorScheme(_style.default.infoSheetIcon, _style.default.infoSheetIconDark); // translators: %s: Name of the block

      var titleFormat = _reactNative.Platform.OS === 'android' ? (0, _i18n.__)("'%s' isn't yet supported on WordPress for Android") : (0, _i18n.__)("'%s' isn't yet supported on WordPress for iOS");
    ...
    value: function render() {
      ...
      var icon = blockType ? (0, _blocks.normalizeIconObject)(blockType.settings.icon) : 'admin-plugins';
