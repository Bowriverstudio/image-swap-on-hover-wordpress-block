...
shortcode, archives, audio, button, calendar, categories, code, columns, column, cover, embed].concat((0, _toConsumableArray2.default)(embed.common), (0, _toConsumableArray2.default)(embed.others), [file, html, mediaText, latestComments, latestPosts, missing, more, nextpage, preformatted, pullquote, rss, search, separator, reusableBlock, spacer, subhead, table, tagCloud, textColumns, verse, video]).reduce(function (accumulator, block) {
